...
\nextproblem
\begin{note}
    You are not responsible for the problem below.
    The CREATE INDEX CONCURRENTLY command creates a lock on a ``virtualxid'', which is something that you're not responsible for.
    I made a mistake including it in this packet.
\end{note}
\begin{tcolorbox}
\begin{tabular}{p{3.25in}p{3in}}
\hspace{-0.2in}Session 1
