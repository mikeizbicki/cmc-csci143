...
<!--
    1. **Examples:**
       ...
       ```
       How many bytes does the following row take?
       ```
       ...
       1. header:
           1. 23 bytes
           1. no null bitmap
           1. padded to 24 bytes
       1. data:
           1. `a` 4 bytes
           1. 4 bytes padding
       1. total = 24 + 8 = 32 bytes

          4/32 = 12.5% of the storage contains "real data"
       ...
       1. header:
           ...
           1. padded to 24 bytes
       1. columns:
           1. `a` 4 bytes + 4 bytes padding
           1. `b` 8 bytes
           1. `c` 2 bytes + 6 bytes padding
           1. total=24 bytes
       1. total = 24 + 24 = 48 bytes

          14/48 = 27% of the storage contains "real data"
       How many bytes does the following row take?
       ```
