...
1. **Windows (with Putty)**:
    ...
    You can follow [these instructions](https://blog.devolutions.net/2016/11/using-a-ssh-tunnel-to-reach-a-protected-server-part-1-local-port-forwarding-2/) to get pictures of where the checkboxes are located.
